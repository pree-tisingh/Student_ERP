...
import { View, Text, TouchableOpacity, FlatList, Image, StyleSheet,Platform,StatusBar } from 'react-native';
  ...
  const renderItem = ({ item }) => (
    ...
    >
      <View style={styles.boxContent}>
        ...
        <Text style={styles.subjectInfo}>Weekly Classes: {item.weeklyClasses}</Text>
