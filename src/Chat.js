...
const ChatList = ({ navigation }) => {
  ...
  const chats = [
    { id: '1', name: 'Akshay Sinha', lastMessage: 'Bye.', online: true, profilePic: require('../assets/img/ic.png') },
    { id: '2', name: 'Ayushi Jaiswal', lastMessage: 'See you later.', online: false, profilePic: require('../assets/img/ic.png') },
    { id: '3', name: 'Nandini Pathak', lastMessage: 'okay.', online: true, profilePic: require('../assets/img/ic.png') },
    { id: '4', name: 'Roshni Singh', lastMessage: 'Thank you.', online: false, profilePic: require('../assets/img/ic.png') },
    { id: '5', name: 'Divya Salame', lastMessage: 'Have a nice day', online: false, profilePic: require('../assets/img/ic.png') },
  ];
      ...
      <View style={styles.container2}>
        <View style={styles.chatHeader}>
          ...
          <View style={styles.chatHeaderIcons}>
            <TouchableOpacity>
              <MaterialIcons name="camera-alt" size={24} color="#333" style={styles.icon} />
            </TouchableOpacity>
            <TouchableOpacity>
