...
import { View, Text, TouchableOpacity, StyleSheet, Image, FlatList,Dimensions ,Platform , StatusBar} from 'react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.sectionContainer}>
        <TouchableOpacity
          style={[styles.section, selectedSection === 'boys' && styles.activeSection]}
        ...
        <TouchableOpacity
          style={[styles.section, selectedSection === 'girls' && styles.activeSection]}
      ...
      {selectedSection && (
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              style={[styles.hostelItem, activeHostel === item.id && styles.activeHostelItem]}
              onPress={() => {
